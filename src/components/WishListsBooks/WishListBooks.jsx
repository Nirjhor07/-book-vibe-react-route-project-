...
const WishListBooks = () => {
  ...
  return (
    <div className="container mx-auto mt-10 mb-10 px-4">
      <h2 className="text-3xl font-bold text-center mb-8">My Reading List</h2>
      {wishList.length === 0 ? (
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-500 space-y-1 mb-3">
                    <div className="flex items-center gap-2">
                      <span className="text-lg"><SlCalender></SlCalender></span>
                      <p>Year of Publishing: {book.yearOfPublishing}</p>
                    </div>
                    <div className="flex items-center gap-2">
                      <span className="text-lg"><FaBookOpen></FaBookOpen></span>
                      <p>
